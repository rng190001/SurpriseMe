...
Welcome to SurpriseMe, a chatbot-driven platform designed to help users find the perfect gifts for anniversaries and Christmas! Whether you’re searching for something sweet and romantic or something festive and merry, our app offers tailored gift suggestions based on user preferences.

##  ![image](https://github.com/user-attachments/assets/377e33a0-eb64-45c9-bac2-bcac2a113391) Features
  - **Holiday-Themed Gift Suggestions:** Curated for both anniversaries and Christmas, ensuring a unique and relevant selection of gift ideas.
  ...
  - **NLP Techniques & Models:**
      - BERT (Bidirectional Encoder Representations from Transformers): Used to generate context-aware embeddings for user queries and dataset entries. BERT captures deep semantic relationships between words, enabling it to evaluate similarity beyond surface-level patterns. The embeddings are compared using cosine similarity to measure the alignment between user queries and gift descriptions.
      - TF-IDF (Term Frequency-Inverse Document Frequency): Utilized to quantify the importance of words within the context of the gift dataset. TF-IDF helps identify the relevance of specific terms, contributing to the similarity measurement between user input and gift descriptions in the database.
      - Cosine Similarity: Applied to compute the final similarity scores by comparing the embeddings generated by BERT and the TF-IDF vectors. Weighted contributions from both models were combined to determine the most relevant gifts based on user queries.
    
## ![image](https://github.com/user-attachments/assets/b37223d7-f6f0-4b1e-bbac-3a67b167834b) Dataset 
  - The dataset is **custom-made** to ensure accurate and personalized recommendations for major holidays, such as Christmas and anniversaries.
